%TO FIND TIME RATIO of SVD 1st ORDER vs RANDOM OUTER PRODUCT BASED
%APPROXIMATION
% Change the A,B as per the test-case
orders=[100;500;700;1000;1500;2000];
...
for k=1:length(tollist)
    ...
    print(gcf, sprintf('SVD_vs_Random_timeratio_tol_%.2f.png', tol), '-dpng', '-r600');
